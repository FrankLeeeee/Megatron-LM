...
def megatron_mlp_run(rank, world_size, batch_size, input_row, hidden_dim, output_path, **args):
    # set cuda device
...
#     print("{} : mlp initialized".format(rank))
    ...
    memory_log = 'megatron_world_{}_bs_{}_row_{}_dim_{}_memory.txt'.format(
    ...
    if rank == 0:
        ...
        duration_file_name = 'megatron_world_{}_bs_{}_row_{}_dim_{}_iter_{}_duration.txt'.format(
        ...
        img_name = 'megatron_world_{}_bs_{}_row_{}_dim_{}_iter_{}_duration.jpg'.format(
            world_size, batch_size, input_row, hidden_dim, num_iters)
    ...
    if rank == 0:
        ...
        sys_info_file_name = 'megatron_world_{}_bs_{}_row_{}_dim_{}_sysinfo.txt'.format(
            world_size, batch_size, input_row, hidden_dim
        )
