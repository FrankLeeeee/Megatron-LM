...
#         print("rank:{} col_group:{}".format(rank, col_ranks))
    ...
    if rank == 0:
        profiling_file_name = './profiling/summa_world_{}_bs_{}_row_{}_dim_{}_profiler.txt'.format(
    ...
    if rank == 0:
        ...
        duration_file_name = './profiling/summa_world_{}_bs_{}_row_{}_dim_{}_iter_{}_duration.txt'.format(
        ...
        img_name = './profiling/summa_world_{}_bs_{}_row_{}_dim_{}_iter_{}_duration.jpg'.format(
            world_size, batch_size, input_row, hidden_dim, num_iters)
